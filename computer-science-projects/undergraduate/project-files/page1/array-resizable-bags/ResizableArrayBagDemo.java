/**
 * This is the driver for the ArrayBag. This tests the methods created for the lab.
...
/**
 * I completed the difference method as well.
 */
public class ResizableArrayBagDemo
{
    ...
    public static void main(String[] args)
    {
        ...
        BagInterface<String> bag = new ResizableArrayBag<>(3);
        
        //Test the resizeableArrayBag with a given array input
        String[] inputArray = {"W", "D", "F", "N", "P", "E", "M", "J", "X", "I"};
        arrayToString(inputArray); //Print the contents of array 1
        BagInterface<String> aBag = new ResizableArrayBag<>(inputArray);
        
        String[] inputArray2 = {"W", "D", "F", "N", "P", "E", "M", "M", "Q", "R", "Z", "A"};
        arrayToString(inputArray2); //print the contents of array 2
        BagInterface<String> bBag = new ResizableArrayBag<>(inputArray2);
        
        //Testing methods from the Lab
        //Test the equals method
        System.out.println("Bags: aBag and bBag are equal: " + aBag.equal(bBag));
        ...
        displayBag(dBag);
        System.out.println("Testing the differnce method: ");
        BagInterface<String> eBag = aBag.difference(bBag);
        displayBag(eBag);
        System.out.println("\n\n\n");
        aBag.clear();
        
        testIsEmpty(bag, true);
        ...
        testFrequency(bag, testStrings2);
        testContains(bag, testStrings2);
    ...
    /**
     * ToString to display input array values
     * @param array : object[] - 
     */
